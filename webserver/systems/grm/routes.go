...
func WebRouters(app *echo.Echo) {
	...
	{
		gfudashboard.GET("", controllers.GFUdashboard.Index)

	}

	grcdashboard := grmApp.Group("/grcdashboard")
	{
		grcdashboard.GET("", controllers.GRCdashboard.Index)

	}

	officerdashboard := grmApp.Group("/officerdashboard")
	{
		officerdashboard.GET("", controllers.Officerdashboard.Index)

	}

	complainant := grmApp.Group("/complainant")
	{
		complainant.GET("", controllers.Complainant.Index)
		complainant.GET("/academic_issue", controllers.Complainant.Academic)
		complainant.GET("/extra_curricular", controllers.Complainant.Extra_curricular)
		complainant.GET("/maintanance", controllers.Complainant.Maintanance)
		complainant.GET("/otherRelatedIssues", controllers.Complainant.OtherRelatedIssues)
		complainant.GET("/placements", controllers.Complainant.Placements)
		complainant.GET("/general", controllers.Complainant.General)
		complainant.GET("/annonymus", controllers.Complainant.Grievance)
		complainant.GET("/complaints", controllers.Complainant.Complaints)

	}

	followup := grmApp.Group("/followup")
	{
		followup.GET("", controllers.Followup.Index)
	}

	login := grmApp.Group("/login")
	{
